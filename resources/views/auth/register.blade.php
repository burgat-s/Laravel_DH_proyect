        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <span style="color:red;" id="erroruser_name"></span>
                    ...
                    <a href="/login" style="margin-top:10px;"  class="btn btn-secondary btn-lg active" role="button" aria-pressed="true"> si ya tienes una cuenta, logueate!</a>
                </div>
            </div>
        </div>
    </div>
